...
for layer in conv_base.layers:
    if layer.name in ['block4_conv1']:  # 'block5_conv1'e kadar ve dahil olmak üzere dondur
...
model.save('my_model.h5',owerwrite =True)
...
model.save('manzara_tf_model.h5')
 ...
 #   os.remove('my_model.h5')  # Eski dosyayı sil

#model.save('my_model.h5')  # Yeni modeli kaydet
